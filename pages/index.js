...
export default function Home() {
  return (
    <div className="valaxy-wrapper lg:custom-image-lg md:custom-image-md xl:custom-image-xl">
      <Head>
        <title>Valaxy is launching soon...</title>
        <meta
          name="description"
          content="Valaxy is the destination to share and discover verified token utilities from airdrops to real-world benefits, and everything in between."
        />
        <link
        ...
        <link rel="mask-icon" href="/safari-pinned-tab.svg" color="#050407" />
        <meta name="msapplication-TileColor" content="#050407" />
        <meta name="theme-color" content="#050407"></meta>
      </Head>

      <header>
        <div className="valaxy-header">
          <a className="valaxy-logo-container">
            <img src="/logo.svg" alt="logo" className="logo" />
            {/* <span className="ml-3 text-xl font-bold">Valaxy</span> */}
          </a>
          <nav className="valaxy-main-nav">
            <a href="#" className="valaxy-nav-link">
              About
            </a>
            {/* <a
              href="https://discord.gg/Hup4HDpn"
              className="valaxy-nav-link"
              target="_blank"
              rel="noreferrer"
            >
              Join our Discord
      ...
      <main>
        <section className="valaxy-hero-section">
          <div className="bg-wrapper"></div>
          <div className="valaxy-hero-container">
            <h2>
              Valaxy is <span className="text-gradient">launching soon</span>
            </h2>
            <p>
              Tired of wasting hours cross-checking information from Discord,
              Telegram and Twitter?
            </p>
            <p>
              Valaxy is the destination to share and discover verified token
              utilities from airdrops to real-world benefits, and everything in
              between.
            </p>
      ...
      <footer>
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p className="text-sm text-gray-300 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
            © {new Date().getFullYear()} Valaxy —
            <a
              href="https://twitter.com/valaxyio"
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a
              href="https://www.instagram.com/valaxyio/"
              target={"_blank"}
              rel="noreferrer"
              className="ml-3 text-gray-300"
            >
