import { ChevronLeftIcon, MailIcon, PhoneIcon } from "@heroicons/react/outline";
...
export default function DAODetails() {
  return (
    <>
      {/* Breadcrumb */}
      <nav
        className="flex items-start px-4 py-3 sm:px-6 lg:px-8 bg-gray-100"
      ...
      <article className="bg-gray-100 pb-8">
        ...
        {/* Description list */}
        <div className="mt-6 max-w-5xl mx-auto space-y-8 px-4 sm:px-6 lg:px-8">
